...
class RegistrantAdmin(admin.ModelAdmin):
    list_display = ('uid','first_name', 'last_name', 'email', 'phone_number', 'state', 'country', 'accommodation', 'marital_status')
    list_filter = ('state', 'country', 'accommodation', 'marital_status')
    search_fields = ('uid','first_name', 'last_name', 'email', 'phone_number')
